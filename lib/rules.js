...
const Dataset = {
  '@type': {
    ...
    validate: function ({ error, results }, values, entity, crate) {
      var type;
  ...
  hasPart: {
    ...
    validate : function({ error, info }, values, entity, crate) {
      ...
      const typesOfFile = {
        ...
        'Annotation': [],
        'DerivedMaterial': []
      }; // Build a lookup by PrimaryMaterial, Annotaton, Derived Material for reporting
      for (item of values) {
...
const PrimaryMaterial = {
  ...
  language: {
    clause: 'It MUST a language property and/or the parent RepositoryObject MUST have a language property, referencing a Language item',
