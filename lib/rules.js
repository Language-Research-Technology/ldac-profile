...
const PrimaryMaterial = {
  '@type': {
    clause: 'It MUST have a @type value of “PrimaryMaterial" and MAY have other @type values',
    validate: function ({ error }, values) {
  ...
  language: {
    clause: 'It MUST a language property, or the RepositoryObject that is `partOf` MUST have a language property, referencing a Language item (language my be inhereted from the parent RepoObject)',
...
const DerivedMaterial = {
  '@type': {
    clause: 'It MUST have a @type value of “DerivedMaterial" and MAY have other @type values',
    validate: function ({ error }, values) {
...
const Annotation = {
  '@type': {
    clause: 'It MUST have a @type value of “Annotation" and MAY have other @type values',
    validate: function ({ error }, values) {
